...
class Customer extends \App\Entity\Customer implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Customer' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Customer' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Customer' . "\0" . 'phoneNumber', '' . "\0" . 'App\\Entity\\Customer' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Customer' . "\0" . 'address', '' . "\0" . 'App\\Entity\\Customer' . "\0" . 'orders'];
        }
     ...
     * {@inheritDoc}
     */
    public function setPhoneNumber(string $phoneNumber): \App\Entity\Customer
    {
